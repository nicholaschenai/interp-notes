...
Currently in the midst of refactoring to separate md files

## Index
### Mechanistic interpretability
#### CNNs
- [Curve circuits](papers/curve-circuits.md)

#### Transformers
- [A Mathematical Framework for Transformer Circuits](papers/mathematical-framework-transformer-circuits.md)
- [In-context Learning and Induction Heads](papers/icl-induction-heads.md)
